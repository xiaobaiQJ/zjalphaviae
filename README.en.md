...
[Hub Address](https://hub.docker.com/repository/docker/alphaviae94/chatgpt-web/general)
...
services:
  app:
    image: alphaviae94/chatgpt-web # always use latest, pull the tag image again when updating
    ports:
      - 127.0.0.1:3002:3002
    environment:
      # one of two
